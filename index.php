...
<body>
    ...
    <header>
        <nav>
            <!-- Header top -->
            <div class="d-flex space-between align-center" id="header-top">
                <a href="#">
                    <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google Logo" id="logo">
                    <h1 id="title">Privacy e termini</h1>
                </a>
                <a href="#">
                    <img src="https://lh3.googleusercontent.com/ogw/AOh-ky3JWwFeCBPsTyF6ytK6p26Nj3s1Yt8YT4p7f4Gx=s32-c-mo" alt="Fabrizio user">
                </a>
            </div>
            <!-- Header bottom -->
    ...
    <main class="container">
        <?php foreach ($faqs as $question => $reply) : ?>
            <section>
                <?= "<h2>$question</h2>" ?>
                <?php foreach ($reply as $paragraph) : ?>
                    <?= "$paragraph"; ?>
                <? endforeach; ?>
            </section>
        <? endforeach; ?>
